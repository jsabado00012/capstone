            ...
            @foreach($users as $user)
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        ...
                        <a href="/users/{{$user->id}}" title="Edit User">
                            <button type="button" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button>
                        </a>
                        <a href="/reset_password/{{$user->id}}" title="Reset Password">
                            <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-undo"></i></button>
                        </a>
                    </td>
                </tr>
            @endforeach
